...
public class ChatActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        FirebaseUtil.getOthertProfilePicStorageRef(otherUser.getUserId()).getDownloadUrl()
    ...
    void getOrCreateChatroomModel(){
        ...
        void callApi(JSONObject jsonObject){
            ...
            Request request = new Request.Builder()
                    .url(url)
                    .post(body)
                    .header("Authorization", "Bearer AAAANhBWobo:APA91bEPqSrMR0W2lTaTNLCNd8dZ6Js0HZm_24pQrAFz0QvwLP5TVRn8VANzhUpuhViS-xNk4HyPbKdOC8mAi4I9V5JuTIT3LGc2AzbFECbyEeOGbfHMMnqDmUiF-ibFCfFDtwjTegdk")
                    .build();
